...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../dxdr4/light.vs", (WCHAR*)L"../dxdr4/light.ps");
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::ChangeFilter(ID3D11Device* device, D3D11_FILTER filter, int i)
{
	HRESULT result;
	D3D11_SAMPLER_DESC samplerDesc;
