	...
	float screenNear)
{
	...
	//그래픽 카드 이름, 메모리 용량 txt출력
	std::ofstream write;

	write.open("VideoInfo.txt");
	write << "VideoCard Name : " << m_videoCardDescription << "\n";
	write << "Memory Size(MB) : " << (int)(adapterDesc.DedicatedVideoMemory / 1024 / 1024);
...
bool D3DClass::ChangeFillMode(D3D11_FILL_MODE fillmode)
{
	HRESULT result;
	D3D11_RASTERIZER_DESC rastDesc;
	
	m_rasterState->GetDesc(&rastDesc);
