...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*)L"../dxdr4/texture.vs", (WCHAR*)L"../dxdr4/texture.ps");
	if (!result)
	{
		return false;
	}
...
// This setup needs to match the VertexType stucture in the ModelClass and in the shader.
	...
	samplerDesc.MaxAnisotropy = 1;//이거 변경해야 함
...
bool TextureShaderClass::ChangeFilter(ID3D11Device* device, D3D11_FILTER filter, int i)
{
	HRESULT result;
	D3D11_SAMPLER_DESC samplerDesc;
